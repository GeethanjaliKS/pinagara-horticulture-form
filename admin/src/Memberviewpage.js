...
{/* <div
  ...
  <Link to="/member" className="text-blue-500 font-bold font-serif hover:text-blue-900 text-2xl " style={{fontFamily:'Dancing Script'}}>
            ADD
          </Link> 
</div>
...
<div className='pt-[5%]   '>
<div
    className="block rounded-lg bg-slate-300  p-6 shadow-lg shadow-slate-400 hover:drop-shadow-xl duration-300 focus dark:bg-neutral-800  md:w-1/2 ">
  <h5
  ...
  Behold the comprehensive details of our esteemed members
  </p>
  <div className='text-end'>
