...
<div
  ...
  <Link to="/worker" className="text-blue-500 font-bold font-serif hover:text-blue-900 text-2xl " style={{fontFamily:'Dancing Script'}}>
            ADD
          </Link> 
</div>
...
<div
  ...
  <div className='text-end'>
    <Link to="/tableworker" className="text-blue-500 font-bold font-serif hover:text-blue-900 text-2xl" style={{fontFamily:'Dancing Script'}}>
            VIEW
          </Link> 
 </div> 
  </div>
