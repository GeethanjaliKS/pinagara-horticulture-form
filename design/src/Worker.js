...
useEffect(() => {
 ...
 workercount ();
  ...
  return (
    ...
    <div className="border max-w-md mx-auto bg-white rounded-lg overflow-hidden shadow-lg shadow-green-300 pt-[2%]">
      <h1 className='text-center text-4xl' style={{fontFamily:'Bitter'}}>Customer Hire Center</h1>
     <div className='text-center pt-[2%] mb-[2%] mt-[5%]' style={{fontFamily:'Tektur'}}>
      <p>weed cutters</p>
